...
(function() {
  ...
  function handleSubmit(e) {
    ...
    fetch(config.url + '/rest/v1/applications', {
      ...
      alert('Something went wrong. Please try again or email hello@indiepair.com');
