...
(function() {
  ...
  var templates = {
    ...
    success: '<div class="ip-success"><div class="ip-success-icon">🎉</div><h3 class="ip-success-title">You\'re in!</h3><p class="ip-success-text">We\'ll review your application and reach out within 48 hours if you\'re a good fit for our founding member beta.</p><div class="ip-success-footer"><p>Follow us: <a href="https://twitter.com/amd_saad" target="_blank" class="ip-link">@amd_saad</a></p></div></div>'
  };
